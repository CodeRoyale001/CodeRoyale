            ...
            <SelectContent>
              <SelectGroup>
                {textSizes.map((textSize) => (
                  <SelectItem key={textSize} value={textSize.toString()}>
                    {textSize}
                  </SelectItem>
                ))}
              </SelectGroup>
        ...
        <AlertDialog>
          ...
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                You are about to reset the code. This action is irreversible and
      ...
      <div className="flex items-center p-3 pr-5 bg-background justify-end">
        <Dialog>
          ...
          <DialogTrigger asChild>
            <Button
              onClick={mode == "EDITOR" ? handleAddCodeSubmission : handleRun}
            >
              Run Code
            </Button>
          </DialogTrigger>
