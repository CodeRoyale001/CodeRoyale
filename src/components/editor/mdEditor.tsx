...
import { BoldIcon, CodeIcon, ItalicIcon, LinkIcon, QuoteIcon, ListOrderedIcon, ListIcon, ListTodoIcon, HeadingIcon } from "lucide-react";
	...
	return (
		<span
			style={{
				...
				borderRight: preview === "edit" ? "1px solid hsl(var(--border))" : "none",
